...
export const buildSystemPrompt = ({
  ...
  return [
    ...
    '- Category bulk price draft actions are allowed only when the host app exposes an approved category write action. Include the exact category identifier/name/slug, price field, pricing operation, currency, and max affected item limit.',
    '- If the user asks for a category/group price edit, use approved read-only category/product tools first when available; otherwise ask for the missing category or product identifier.',
